...
/**
 * 项目列表与归档（issue #17 清场后骨架）。列表 `status` 为过滤视图（Integer
 * code，映射收在 lib/projects/list）；归档为单向终点——200 返回最新详情，播种 +
 * 失效项目域（use-project.ts 的 seedAndInvalidate）。
 */
