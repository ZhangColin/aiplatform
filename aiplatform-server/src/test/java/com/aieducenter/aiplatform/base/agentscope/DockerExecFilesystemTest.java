...
import com.aieducenter.aiplatform.base.agentscope.DockerExecFilesystem.ExecCommand;
import com.aieducenter.aiplatform.base.agentscope.DockerExecFilesystem.ExecOutput;
...
/**
 * {@link DockerExecFilesystem}（fake ExecCommand）：命令形状（根目录
